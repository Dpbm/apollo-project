...
Giving the task to create a comprehensive pipeline that includes data preprocessing, visualization, classification, manual implementation of key metrics, and insightful analysis. I implemented this application using Python and `Streamlit`.

The code here do all the necessary parsing, analysis, modeling, training and evaluation for the pipeline, being all managed in a easy to use Dashboard.

> Disclaimer: To test it quickly, I first did some jupyter notebooks and then transferred the knowledge into python scripts. These notebooks can be accessed in the `experiments` folder.
...
Also, use python $>= 3.12$ to ensure compatibility.
